...
@Configuration
@EnableJpaRepositories(basePackages = "com.roadscanner.bookingservice.adapter.out.persistence")
@EntityScan(basePackages = "com.roadscanner.bookingservice.adapter.out.persistence")
