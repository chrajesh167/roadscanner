package com.roadscanner.searchservice.adapter.out.security;
 ...
 * service's own decoder will accept, without a live {@code auth-service} to call — the same
 * arrangement {@code booking-service} and {@code payment-service} use.
 */
