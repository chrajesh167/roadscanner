 ...
 * {@code auth-service}'s own security-design rationale (docs/services/auth-service/security-design.md).
 */
public record JwtDecoderKeyMaterial(RSAPublicKey publicKey, String keyId) {
    ...
    public static JwtDecoderKeyMaterial fromPem(String publicKeyPem) {
        try {
            ...
            throw new IllegalStateException("Configured JWT public key is not a valid RSA PEM (X.509 public key)", e);
        }
    }
